...
To do so, we used data about the total population of each region contained into \emph{platea.csv}.\todo{nomi index!!!}
\begin{tcolorbox}[fontupper=\scriptsize]
  \begin{verbatim}
...
\item The number of healed people for each region that can be found in \emph{soggetti-guariti.csv}.\todo{nomi index!!!}
 \end{itemize}
\begin{tcolorbox}[fontupper=\scriptsize]
  \begin{verbatim}
...
We used data coming from \emph{dpc-covid-19-ita-regioni-combined.csv}. \todo{nomi index}
\begin{tcolorbox}[fontupper=\scriptsize]
  \begin{verbatim}
...
It returns the ratio between positive and hospitalized people in each region.\todo{nome index!!!}
