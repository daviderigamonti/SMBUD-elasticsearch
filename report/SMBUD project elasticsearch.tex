...
In order to use this dashboard, you need to create four indexes, one for each csv file (\emph{somministrazioni-vaccini-latest.csv, platea.csv, soggetti-guariti.csv, dpc-covid19-ita-regioni.csv}),
and name them respectively: "index-vaccines\_administrations", "index-population", 
"index-healed" and "index-covid-information". \\
